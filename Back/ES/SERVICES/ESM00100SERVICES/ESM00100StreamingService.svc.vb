...
Public Class ESM00100StreamingService
    ...
    Public Function GetAppList() As System.ServiceModel.Channels.Message Implements IESM00100StreamingService.GetAppList
        Dim loEx As New R_Exception
        Dim loCls As New ESM00100ApprovalCls
        Dim loRtnTemp As List(Of ESM00100PrintProcessDTO)
        Dim loRtn As Message = Nothing
        Dim loParam As New ESM00100ParamDTO
        Dim loList As List(Of Byte())
        ...
        Try
            With loParam
                .CCOMPANY_ID = R_Utility.R_GetStreamingContext("CCOMPANY_ID")
                .CSEARCH_LIST = R_Utility.R_GetStreamingContext("CSEARCH_LIST")
                .CFLAG = R_Utility.R_GetStreamingContext("CFLAG")
            End With

            loRtnTemp = loCls.GetAppList(loParam)

            loList = R_Utility.R_GetChunkData(Of ESM00100PrintProcessDTO)(loRtnTemp, R_BackGlobalVar.CHUNK_SIZE)
            loRtn = R_StreamUtility(Of Byte()).WriteToMessage(loList.AsEnumerable, "GetAppList")
    ...
    Public Function PrintProcess() As System.ServiceModel.Channels.Message Implements IESM00100StreamingService.PrintProcess
        Dim loEx As New R_Exception
        Dim loCls As New ESM00100ApprovalCls
        Dim loRtnTemp As List(Of ESM00100PrintProcessDTO)
        Dim loRtn As Message = Nothing
        ...
        Try
            ...
            loRtnTemp = loCls.PrintProcess(loParam)

            loList = R_Utility.R_GetChunkData(Of ESM00100PrintProcessDTO)(loRtnTemp, R_BackGlobalVar.CHUNK_SIZE)
            loRtn = R_StreamUtility(Of Byte()).WriteToMessage(loList.AsEnumerable, "PrintProcess")
