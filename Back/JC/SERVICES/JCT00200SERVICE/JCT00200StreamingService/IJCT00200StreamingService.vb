...
' NOTE: You can use the "Rename" command on the context menu to change the interface name "IJCT00200StreamingService" in both code and config file together.
<ServiceContract()>
Public Interface IJCT00200StreamingService
