...
Imports ATR00520Common
Imports R_BackEnd
' NOTE: You can use the "Rename" command on the context menu to change the class name "ATR00520StreamingService" in code, svc and config file together.
Public Class ATR00520StreamingService
    Implements IATR00520StreamingService

    Public Function getReport() As System.ServiceModel.Channels.Message Implements IATR00520StreamingService.getReport
        Dim loException As New R_Exception
        Dim loCls As New ATR00520CLS
        Dim poParam As New ATR00520DTO
        Dim loRtnList As List(Of ATR00520StreamingDTO)
        ...
        Try
            ...
            loList = R_Utility.R_GetChunkData(Of ATR00520StreamingDTO)(loRtnList, R_BackGlobalVar.CHUNK_SIZE)
