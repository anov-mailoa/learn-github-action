...
Imports ATR00510Common
Imports R_BackEnd
' NOTE: You can use the "Rename" command on the context menu to change the class name "ATR00510StreamingService" in code, svc and config file together.
Public Class ATR00510StreamingService
    Implements IATR00510StreamingService

    Public Function getReport() As System.ServiceModel.Channels.Message Implements IATR00510StreamingService.getReport
        Dim loException As New R_Exception
        Dim loCls As New ATR00510CLS
        Dim poParam As New ATR00510DTO
        Dim loRtnList As List(Of ATR00510StreamingDTO)
        ...
        Try
            ...
            loList = R_Utility.R_GetChunkData(Of ATR00510StreamingDTO)(loRtnList, R_BackGlobalVar.CHUNK_SIZE)
