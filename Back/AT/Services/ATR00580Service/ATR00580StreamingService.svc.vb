...
Imports ATR00580Common
Imports R_BackEnd
' NOTE: You can use the "Rename" command on the context menu to change the class name "ATR00580StreamingService" in code, svc and config file together.
Public Class ATR00580StreamingService
    Implements IATR00580StreamingService

    Public Function getReport() As System.ServiceModel.Channels.Message Implements IATR00580StreamingService.getReport
        Dim loException As New R_Exception
        Dim loCls As New ATR00580CLS
        Dim poParam As New ATR00580DTO
        Dim loRtnList As List(Of ATR00580ReportDTO)
        ...
        Try
            ...
            loList = R_Utility.R_GetChunkData(Of ATR00580ReportDTO)(loRtnList, R_BackGlobalVar.CHUNK_SIZE)
