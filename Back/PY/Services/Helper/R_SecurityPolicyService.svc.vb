...
Public Class R_SecurityPolicyService
    ...
    Public Sub Svc_R_AdminLoginValidation(pcAdminEmail As String) Implements IR_SecurityPolicyService.Svc_R_AdminLoginValidation
        Dim loException As New R_Exception

        Try
            Dim loClass As New R_BackEnd.R_SecurityPolicyBack

            loClass.R_AdminLoginValidation(pcAdminEmail)
        Catch ex As Exception
            loException.Add(ex)
        End Try
    ...
    Public Function Svc_R_CheckAdminDb() As Boolean Implements IR_SecurityPolicyService.Svc_R_CheckAdminDb
        Dim loException As New R_Exception
