...
Public Interface IMenuStreamingService
    ...
    Sub Dummy(ByVal poPar As List(Of MenuDTOnon), ByVal poPar1 As List(Of MenuDashboardDTOnon))

    <OperationContract(Action:="GetDashBoardMenu", ReplyAction:="GetDashBoardMenu")>
    <FaultContract(GetType(R_ServiceExceptions))>
    Function GetDashBoardMenu() As Message
End Interface
