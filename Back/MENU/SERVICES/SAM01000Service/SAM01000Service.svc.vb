...
Public Class SAM01000Service
    ...
    Public Sub CheckSupportedEmailProvider(pcCompanyId As String, pcSMTPId As String) Implements ISAM01000Service.CheckSupportedEmailProvider
        Dim loEx As New R_Exception
        Dim loCls As New SAM01000Cls

        Try
            loCls.CheckSupportedEmailProvider(pcCompanyId, pcSMTPId)
        Catch ex As Exception
            loEx.Add(ex)
        End Try
