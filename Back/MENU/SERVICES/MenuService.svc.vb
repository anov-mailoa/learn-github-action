...
Public Class MenuService
    ...
    Public Sub UpdateDashboardPosition(poParameter As UpdatePositionDashboardDTO) Implements IMenuService.UpdateDashboardPosition
        Dim loException As New R_Exception

        Try
            Dim loClass As New MenuCls

            loClass.UpdateDashboardPosition(poParameter)
        Catch ex As Exception
            loException.Add(ex)
        End Try
