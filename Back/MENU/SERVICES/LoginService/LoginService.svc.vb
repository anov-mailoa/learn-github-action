...
Public Class LoginService
    ...
    Public Function GetMFAMode(pcCompanyId As String, pcUserId As String) As MfaDTO Implements ILoginService.GetMFAMode
        Dim loEx As New R_Exception
        Dim loClass As New LoginCls
        Dim loResult As MfaDTO = Nothing

        Try
            loResult = loClass.GetMFAMode(pcCompanyId, pcUserId)
        Catch ex As Exception
            loEx.Add(ex)
        End Try
