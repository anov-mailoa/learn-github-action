...
' NOTE: You can use the "Rename" command on the context menu to change the class name "LNR01300StreamingService" in code, svc and config file together.
Public Class LNR01300StreamingService
    Implements ILNR01300StreamingService

    Public Function getReport() As System.ServiceModel.Channels.Message Implements ILNR01300StreamingService.getReport
        Dim loException As New R_Exception
        Dim loCls As New LNR01300CLS
        Dim loRtnTemp As List(Of LNR01300ReportDTO)
        Dim loRtn As Message
        Dim loParam As New LNR01300DTO
        ...
        Try
            ...
            loList = R_Utility.R_GetChunkData(Of LNR01300ReportDTO)(loRtnTemp, R_BackGlobalVar.CHUNK_SIZE)
